...
public class HealthController : ControllerBase
{
    ...
    private static Jackson.Ideas.Mock.Models.BusinessIdeaScenario CreateTestScenario()
    {
        return new Jackson.Ideas.Mock.Models.BusinessIdeaScenario
        {
            ...
            {
                Revenue = new Jackson.Ideas.Mock.Models.RevenueProjections { Year1Total = 10000 },
                CashFlow = new Jackson.Ideas.Mock.Models.CashFlowProjections { BreakEvenMonth = 6 }
            }
        };
    }
}